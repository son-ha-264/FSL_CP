...
def main():
    ...
    pretrain_logs_path = '/home/son.ha/FSL_CP/logs/multitask_cp_pretrain'
    path_to_weight = os.path.join(pretrain_logs_path, 'lightning_logs/version_0/checkpoints/final_model.ckpt')
    logs_path = '/home/son.ha/FSL_CP/logs/multitask_cp_finetune'
   ...
   ### Load hparams from JSON files
    ...
    for support_set_size in support_set_sizes:
        for rep in range(num_repeat):
            ...
            torch.save(predictions, "/home/son.ha/FSL_CP/output/multitask_pred/multitask_pred_"+str(support_set_size)+"_"+str(rep)+".pt")
